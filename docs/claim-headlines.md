...
| Historical same-profile accelerated A/B median, 83 mods | **15.53s** |
| Historical A/B elapsed-time reduction | **73.47s** |
| Historical A/B percentage reduction | **82.55%** |
| Current retained accelerated development endpoint, 83 mods | **13.69s** |
| Current maintainer-selected ordinary development baseline | **112.17s** |

The current readable development headline is **112.17s → 13.69s**. The 89.00s → 15.53s pair remains the retained interleaved A/B comparison for the separate attribution question it measured.
