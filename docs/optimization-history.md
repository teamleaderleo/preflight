...
cost of roughly 3.08 GB. Fresh profiles bootstrap with Balanced, then automatically graduate to the
smaller learned Compact pack after a successful launch.
