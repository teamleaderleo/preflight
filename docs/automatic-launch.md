...
compiler path, and the prepared spec, merged-read, texture, and audio caches. Every adapter remains
exact-version-gated and retains original behavior on drift or internal failure. The
