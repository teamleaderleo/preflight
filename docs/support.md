...
the uploaded report. If you send a support ZIP, put only the case ID in the issue. The case ID lets
support find the private bounded report without publishing its contents or deletion token.

If sending isn't configured, **Create support ZIP** still creates the same disclosed ZIP locally.
