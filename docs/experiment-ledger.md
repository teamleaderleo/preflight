...
| Whole stack | Randomized vanilla/texture/complete comparison | **Accepted** | Five rounds per condition measured 80.09 seconds vanilla and 42.36 seconds for the then-current complete stack, a 47.1 percent reduction with every round agreeing on direction. | [Whole-stack comparison](evidence/2026-08-03-the-whole-stack-measured-at-once.md) |
