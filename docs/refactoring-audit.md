...
process setup, installation-path validation, read-only snapshot/cache commands, cache pruning,
scoped removal, and diagnostics export. The hostile-input HTTP protocol helpers remain beside their
