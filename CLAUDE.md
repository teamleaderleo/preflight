...
The command always keeps the current worktree, worktrees with source changes, recent output, and the
newest completed build set. Do not preserve exact release evidence by abandoning it under
