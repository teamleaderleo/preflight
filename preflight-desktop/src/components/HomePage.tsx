            ...
            <div className="launch-console__note">
              <span>{preparing
                ? preparationPercent === null
                  ? `${preparationPhaseLabel ?? "Preparation continues"} · Resumed. ${preparation.preparationCompletionIntent === "launch" ? "Starsector opens when preparation finishes." : "Launch from Home when preparation finishes."}`
                  : `${preparationPhaseLabel ?? "Preparing"} · ${preparation.preparationCompletionIntent === "launch" ? "Starsector opens when preparation finishes." : "Launch from Home when preparation finishes."}`
                : cacheNeedsRepair
