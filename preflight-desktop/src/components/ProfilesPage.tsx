    ...
    <div className="profiles-page">
      ...
      {activationPlan ? (
        ...
        >
          ...
          <div className="activation-review__footer">
            <span><ShieldIcon /> Preflight checks the mod-list file again, saves a backup, then applies the change.</span>
      ...
      {mutationPlan ? (
        ...
        >
          ...
          <div className="activation-review__footer">
            <span><ShieldIcon /> Preflight checks the saved profile again before changing it.</span>
