...
/** Memoizes positive deployment member-to-icon scans behind exact live-list validation. */
final class DeploymentIconCachePlan {
    ...
    static byte[] transform(ClassSignature signature, byte[] originalBytes) {
        ...
        if (lookup == null || (lookup.access & (Opcodes.ACC_STATIC | Opcodes.ACC_ABSTRACT
    ...
    private static MethodNode wrapper(String owner, int access) {
        ...
        method.instructions.add(new VarInsnNode(Opcodes.ALOAD, 0));
        method.instructions.add(new VarInsnNode(Opcodes.ALOAD, 1));
        addMembers(method, owner);
        addItems(method, owner);
        method.instructions.add(new MethodInsnNode(
                Opcodes.INVOKESTATIC, RUNTIME, "lookup",
                "(Ljava/lang/Object;Ljava/lang/Object;Ljava/util/List;Ljava/util/List;)Ljava/lang/Object;",
                false));
        ...
        method.instructions.add(new MethodInsnNode(
                ...
                "(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/util/List;Ljava/util/List;)V",
                false));
        method.instructions.add(new VarInsnNode(Opcodes.ALOAD, 3));
        method.instructions.add(new InsnNode(Opcodes.ARETURN));
        return method;
    ...
    private static void addMembers(MethodNode method, String owner) {
        method.instructions.add(new VarInsnNode(Opcodes.ALOAD, 0));
        method.instructions.add(new MethodInsnNode(
                Opcodes.INVOKEVIRTUAL, owner, MEMBERS_METHOD, MEMBERS_DESCRIPTOR, false));
    }

    private static void addItems(MethodNode method, String owner) {
        method.instructions.add(new VarInsnNode(Opcodes.ALOAD, 0));
        method.instructions.add(new MethodInsnNode(
                Opcodes.INVOKEVIRTUAL, owner, LIST_METHOD, LIST_DESCRIPTOR, false));
        method.instructions.add(new MethodInsnNode(
                Opcodes.INVOKEVIRTUAL, GRID, ITEMS_METHOD, "()Ljava/util/List;", false));
    }
